...
describe("BankAccountEntry", () => {
  ...
  it("throws an error if transaction is neither debit nor credit", () => {
  ...
  it("throws an error if transaction is both credit and debit", () => {
    const initialBalance = 1000;
    const type = "credit";
    const amount = 200;
    ...
    expect(() => {
      entry.getType();
    }).toThrow("Error: transaction cannot be both credit and debit");
  });
